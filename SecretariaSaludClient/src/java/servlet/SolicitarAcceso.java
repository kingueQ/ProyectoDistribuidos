 ...
 * @author kingu
 */
@WebServlet(name = "SolicitarAcceso", urlPatterns = {"/SolicitarAcceso"})
public class SolicitarAcceso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String respuesta = cliente.enviarMensaje("enviar!" + curp + "!" + cedula);
